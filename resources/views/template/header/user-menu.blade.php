		...
		<a class="dropdown-toggle hidden-folded" data-toggle="dropdown" href="#">
			<span class="clear">
				<span class="block m-t-sm">
					<strong class="font-bold text-lt">John.Smith</strong> <b class="caret"></b>
				</span>
		...
		<ul class="dropdown-menu animated fadeInRight w hidden-folded">
			<li class="wrapper b-b m-b-sm bg-info m-t-n-xs">
				...
				<div class="progress progress-xs m-b-none dker">
					<div class="progress-bar bg-white" data-original-title="50%" data-toggle="tooltip" style="width: 50%"></div>
				</div>
			</li>
